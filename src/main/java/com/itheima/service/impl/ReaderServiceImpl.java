  ...
  @Autowired
   private ReaderDao readerDao;
    ...
    public IPage<Reader> getPage(int currentPage, int pageSize, Reader reader) {
        ...
        lqw.like(Strings.isNotEmpty(reader.getPhone()), Reader::getPhone, reader.getPhone());
        lqw.like(Strings.isNotEmpty(reader.getGender()), Reader::getGender, reader.getGender());
        lqw.like(Strings.isNotEmpty(reader.getEmail()), Reader::getEmail, reader.getEmail());
