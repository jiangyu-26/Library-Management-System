...
-- Records of tbl_book
-- ----------------------------
INSERT INTO `tbl_book` VALUES (1, '9787229042066', '三体全集', '刘慈欣', '地球往事三部曲', '重庆出版社0', '2012-01-01', 2, '科幻巨作');
...
-- ----------------------------
INSERT INTO `tbl_reader` (`id`, `reader_id`, `reader_name`, `card_id`, `education`, `create_date`, `phone`, `gender`, `email`) VALUES (2, '202005002', '甄姬', 202032, '本科', '2020-06-09', '13800138002', '女', 'zhenji@test.com');
INSERT INTO `tbl_reader` (`id`, `reader_id`, `reader_name`, `card_id`, `education`, `create_date`, `phone`, `gender`, `email`) VALUES (3, '202005003', '诸葛亮', 301002, '本科', '2020-06-09', '13800138003', '男', 'zhugeliang@test.com');
INSERT INTO `tbl_reader` (`id`, `reader_id`, `reader_name`, `card_id`, `education`, `create_date`, `phone`, `gender`, `email`) VALUES (5, '202005008', '曹操', 201001, '硕士', '2020-06-09', '13800138005', '男', 'caocao@test.com');
INSERT INTO `tbl_reader` (`id`, `reader_id`, `reader_name`, `card_id`, `education`, `create_date`, `phone`, `gender`, `email`) VALUES (6, '202005001', '周瑜', 1010026, '硕士', '2020-06-09', '13800138006', '男', 'zhouyu@test.com');
INSERT INTO `tbl_reader` (`id`, `reader_id`, `reader_name`, `card_id`, `education`, `create_date`, `phone`, `gender`, `email`) VALUES (7, '2036526', '赵云', 260355551, '高中', '2022-09-07', '13800138007', '男', 'zhaoyun@test.com');
